...
<html>
    ...
    <div style="margin: auto; width: 900px">
                    ...
                    <div class="invoice-details">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="width-d color-n-b"><?php echo $quote->quote_number; ?></td>
                            </tr>
                            <tr>
                                <td class="color-n">Data wystawienia:</td>
                                <td class="width-d color-n"><?php echo date_from_mysql($quote->quote_date_created, TRUE); ?></td>
                            </tr>
                            <tr>
                                <td class="color-n">Aktualna do:</td>
                                <td class="width-d color-n"><?php echo date_from_mysql($quote->quote_date_expires, TRUE); ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <table>
            ...
            <tr>
                <td class="text-left">
                    <h4 class="company-name"><?php echo $quote->client_name; ?></h4>
                </td>
            </tr>
        </table>
        <table>
            <tr>
                <td class="text-left" width="40%">
                    <?php foreach(array('client_address_1', 'client_address_2', 'client_city', 'client_state', 'client_vat_id') as $field): ?>
                        <?php if (!empty($quote->$field)): ?>
                            <?php if ($field =='client_city'): ?>
                                <?php echo $quote->client_zip; ?> <?php echo $quote->client_city; ?><br/>
                            <?php elseif ($field =='client_vat_id'): ?>
                                <?php echo lang('organization_nip'); ?>: <?php echo $quote->client_country; ?>&nbsp;<?php echo $quote->$field; ?><br/>
                            <?php else: ?>
                                <?php echo $quote->$field; ?><br/>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </td>
                <td>
                    <?php foreach(array('phone_abbr' => 'client_phone', 'mobile_abbr' => 'client_mobile', 'email' => 'client_email', 'web' => 'client_web') as $lang => $field): ?>
                        <?php if (!empty($quote->$field)): ?>
                            <?php echo lang($lang); ?>: <?php echo $quote->$field; ?><br/>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </td>
            </tr>
 ...
 */ ?>
            ...
            <table class="amount-summary">
                ...
                <tr>
                    <th>Podsuma netto:</th>
                    <td style="width:100px"><?php echo format_currency($quote->quote_item_subtotal); ?></td>
                </tr>
                <tr>
            ...
            <table>
                <tr>
                    <th style="text-align: center"><?php echo $quote->user_name; ?></th>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td class="podpisy">Podpis osoby uprawnionej do wystawienia oferty</td>
                    <td style="width:70px"></td>
                    <td class="podpisy">Data odbioru</td>
                    <td style="width:70px"></td>
                    <td class="podpisy">Podpis osoby upoważnionej do odbioru oferty</td>
                </tr>
            </table>
        </div>
    </div>
