                        ...
                        <div class="invoice-to">
                            ...
                            <p><b><?php echo $invoice->client_name; ?></b><br/>
                                ...
                                <?php if ($invoice->client_mobile) { ?>
                                    <?php echo lang('mobile_abbr'); ?>: <?php echo $invoice->client_mobile; ?><br/>
                                <?php } ?>
                                <?php if ($invoice->client_email) { ?>
                                    <?php echo lang('email'); ?>: <?php echo $invoice->client_email; ?><br/>
                                <?php } ?>
                                <?php if ($invoice->client_web) { ?>
                                    <?php echo lang('web'); ?>: <?php echo $invoice->client_web; ?><br/>
                                <?php } ?>
                            </p>
                        </div>
                    ...
                    <td class="text-right" style="width:60%;">
                        <div class="company-details">
                            ...
                            <?php if ($invoice->user_company) { ?>
                                <h4 class="company-name text-right">
                            ...
                            <p class="text-right">
                                ...
                                <?php if ($invoice->user_phone) {
                                    ?><?php echo lang('phone_abbr'); ?>: <?php echo $invoice->user_phone; ?><br>
                                <?php } ?>
                                <?php if ($invoice->user_mobile) {
                                    ?><?php echo lang('mobile_abbr'); ?>: <?php echo $invoice->user_mobile; ?><br>
                                <?php } ?>
                                <?php if ($invoice->user_email) { ?>
                                    <?php echo lang('email'); ?>: <?php echo $invoice->user_email; ?><br/>
                                <?php } ?>
                                <?php if ($invoice->user_web) { ?>
                                    <?php echo lang('web'); ?>: <?php echo $invoice->user_web; ?><br/>
                                <?php } ?>

                                <?php if ($bank_account) { ?>
                                    <br/><?php echo lang('organization_bank_account'); ?>: <?php echo $bank_account; ?><br/>
                                <?php } ?>
                            </p>
                        </div>
                        <br/>
