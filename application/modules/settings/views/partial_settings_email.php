...
<div class="tab-info">
    ...
    <div class="form-group">
        <label for="bcc_mails_to_admin_email" class="control-label">
            <?php echo lang('bcc_mails_to_admin'); ?>
        </label>
        <input type="email" id="bcc_mails_to_admin_email" name="settings[bcc_mails_to_admin_email]" class="input-sm form-control"
               value="<?php echo $this->mdl_settings->setting('bcc_mails_to_admin_email'); ?>">
<?php /* pZ:
...
*/ ?>
    ...
    <hr/>
    <h4><?php echo lang('email_smtp'); ?></h4>
    <br/>


    <input type="hidden" name="settings[email_send_method]" value="smtp">
