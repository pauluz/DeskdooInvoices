...
<ul id="settings-tabs" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li>
        <a data-toggle="tab" href="#settings-organization"><?php echo lang('organization'); ?></a>
    </li>
    <li>
...
<form method="post" id="form-settings" enctype="multipart/form-data">
    ...
    <div class="tabbable tabs-below">
        ...
        <div class="tab-content col-xs-12 col-md-8 col-lg-6">
            ...
            <div id="settings-organization" class="tab-pane">
                <?php $this->layout->load_view('settings/partial_settings_organization'); ?>
            </div>
