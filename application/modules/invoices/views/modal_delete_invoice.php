<script type="text/javascript">
    $(function () {
        $('#modal_delete_confirm').click(function () {
            ...
            window.location = '<?php echo site_url('invoices/delete'); ?>/' + document_id;
        });
    });
</script>
...
<div id="delete-modal" class="modal col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" role="dialog" aria-labelledby="delete-modal" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="alert alert-danger"><?php echo lang('delete_invoice_warning'); ?></p>
        </div>
        <div class="modal-footer">
            <div class="btn-group">
                <a href="#" id="modal_delete_confirm" class="btn btn-danger" data-document-id="<?php echo $invoice->invoice_id; ?>">
