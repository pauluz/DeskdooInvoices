...
class Mdl_Invoices extends Response_Model
{
    const
        ...
        INVOICE_STATUS_OFFERED  = 2,
        INVOICE_STATUS_VIEWED   = 3,
    ...
    public function statuses()
    {
        return array(
/*
            self::INVOICE_STATUS_DRAFT   => array(
                'label' => lang('draft'),
                'class' => 'draft',
                'href'  => 'invoices/status/draft'
            ),
*/
            self::INVOICE_STATUS_OFFERED => array(
                'label' => lang('sent'),
                'class' => 'sent',
                'href'  => 'invoices/status/sent'
            ),
//            self::INVOICE_STATUS_VIEWED => array(
//                'label' => lang('viewed'),
//                'class' => 'viewed',
//                'href'  => 'invoices/status/viewed'
//            ),
            self::INVOICE_STATUS_PAID    => array(
                'label' => lang('paid'),
                'class' => 'paid',
    ...
    {
        // @TODO - pZ: zrobić tak samo jak w metodzie save()
        $this->load->model('invoices/mdl_items');
    ...
    public function db_array()
    {
        ...
        if (!isset($db_array['invoice_status_id'])) {
            $db_array['invoice_status_id'] = self::INVOICE_STATUS_OFFERED;
        }
    ...
    {
        $this->filter_where_in('invoice_status_id', array(self::INVOICE_STATUS_OFFERED, self::INVOICE_STATUS_VIEWED));
        return $this;
    }

    public function guest_visible()
    {
        $this->filter_where_in('invoice_status_id', array(self::INVOICE_STATUS_OFFERED, self::INVOICE_STATUS_VIEWED, self::INVOICE_STATUS_PAID));
        return $this;
    }

    public function is_draft()
    {
        $this->filter_where('invoice_status_id', self::INVOICE_STATUS_DRAFT);
        return $this;
    }

    public function is_sent()
    {
        $this->filter_where('invoice_status_id', self::INVOICE_STATUS_OFFERED);
        return $this;
    }

    public function is_viewed()
    {
        $this->filter_where('invoice_status_id', self::INVOICE_STATUS_VIEWED);
        return $this;
    }

    public function is_paid()
    {
        $this->filter_where('invoice_status_id', self::INVOICE_STATUS_PAID);
        return $this;
    }
    ...
    // @TODO - pZ: zamienić na jedną metodę ustawiającą status - tak samo w quotes
