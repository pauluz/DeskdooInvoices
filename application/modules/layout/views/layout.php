...
<!--[if lt IE 7]>
<html class="no-js ie6 oldie" lang="en" ng-app="InvoiceApp"> <![endif]-->
<!--[if IE 7]>
<html class="no-js ie7 oldie" lang="en" ng-app="InvoiceApp"> <![endif]-->
<!--[if IE 8]>
<html class="no-js ie8 oldie" lang="en" ng-app="InvoiceApp"> <![endif]-->
<!--[if gt IE 8]><!-->
<html class="no-js" lang="en" ng-app="InvoiceApp"> <!--<![endif]-->
...
<head>
    ...
    <script src="<?php echo base_url(); ?>assets/default/js/angular.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/default/js/controllers.js"></script>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <span class="navbar-brand">
                        ...
                        ?>
                        <span style="white-space: nowrap" data-toggle="tooltip" data-placement="bottom" title="
                        company:&nbsp;<?php echo $userdata['company_name'] ?>&nbsp;
                        desktop:&nbsp;<?php echo $userdata['desktop_name'] ?>"><i class="fa fa-info-circle"></i></span>
                    </span>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><?php echo anchor('invoice_groups/index', lang('invoice_quote_groups')); ?></li>
...
<div class="sidebar hidden-xs <?php if ($this->mdl_settings->setting('disable_sidebar') == 1) {
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo site_url('tasks/index'); ?>">
