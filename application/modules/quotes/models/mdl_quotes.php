...
class Mdl_Quotes extends Response_Model
{
    ...
    public function statuses()
    {
        return array(
/*
            self::QUOTE_STATUS_DRAFT    => array(
                'label' => lang('draft'),
                'class' => 'draft',
                'href'  => 'quotes/status/draft'
            ),
*/
            self::QUOTE_STATUS_OFFERED  => array(
                'label' => lang('sent'),
                'class' => 'sent',
                'href'  => 'quotes/status/sent'
            ),
//            self::QUOTE_STATUS_VIEWED   => array(
//                'label' => lang('viewed'),
//                'class' => 'viewed',
//                'href'  => 'quotes/status/viewed'
//            ),
            self::QUOTE_STATUS_APPROVED => array(
                'label' => lang('approved'),
                'class' => 'approved',
                'href'  => 'quotes/status/approved'
            ),
            self::QUOTE_STATUS_REJECTED => array(
                'label' => lang('rejected'),
                'class' => 'rejected',
                'href'  => 'quotes/status/rejected'
            ),
/*
            self::QUOTE_STATUS_CANCELED => array(
                'label' => lang('canceled'),
                'class' => 'canceled',
...
*/
    ...
    public function db_array()
    {
        ...
        if (!isset($db_array['quote_status_id'])) {
            $db_array['quote_status_id'] = self::QUOTE_STATUS_OFFERED;
        }
    ...
    {
        $this->filter_where_in('quote_status_id', array(self::QUOTE_STATUS_OFFERED, self::QUOTE_STATUS_VIEWED));
        return $this;
    }

    public function guest_visible()
    {
        $this->filter_where_in('quote_status_id', array(self::QUOTE_STATUS_OFFERED, self::QUOTE_STATUS_VIEWED, self::QUOTE_STATUS_APPROVED, self::QUOTE_STATUS_REJECTED));
        return $this;
    }

    public function is_draft()
    {
        $this->filter_where('quote_status_id', self::QUOTE_STATUS_DRAFT);
        return $this;
    }

    public function is_sent()
    {
        $this->filter_where('quote_status_id', self::QUOTE_STATUS_OFFERED);
        return $this;
    }

    public function is_viewed()
    {
        $this->filter_where('quote_status_id', self::QUOTE_STATUS_VIEWED);
        return $this;
    }

    public function is_approved()
    {
        $this->filter_where('quote_status_id', self::QUOTE_STATUS_APPROVED);
        return $this;
    }

    public function is_rejected()
    {
        $this->filter_where('quote_status_id', self::QUOTE_STATUS_REJECTED);
        return $this;
    }

    public function is_canceled()
    {
        $this->filter_where('quote_status_id', self::QUOTE_STATUS_CANCELED);
        return $this;
    }
    ...
    // @TODO - pZ: zamienić na jedną metodę ustawiającą status - tak samo w invoices
