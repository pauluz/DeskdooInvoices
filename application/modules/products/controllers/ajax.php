    ...
    public function modal_product_lookups_json()
    {
        ...
        foreach ($products as $product) {
            $data[] = array(
                ...
                'ProductFormatPrice' => format_currency($product->product_price), // pZ: potrzebuje string z walutą
                'ProductPrice'       => format_amount($product->product_price), // tutaj wygląd do budki INPUT
            );
        }
