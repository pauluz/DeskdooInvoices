    ...
    <div id="content">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <textarea name="body" id="body" style="height: 200px;" class="email-template-body form-control taggable"></textarea>
        ...
        <div class="form-group">
            ...
            <?php $this->layout->load_view('documents/drop-html', array('col' => 6)); ?>
        </div>
